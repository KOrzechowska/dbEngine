...
public class SpectrumScoreFromDB
{
    HashMap<Peptide, Double> scoresMap;
    double score;
    public SpectrumScoreFromDB(List<Peptide> sequences, MsMsQuery query)
    {
        /*
    ...
    public SpectrumScoreFromDB(MsMsQuery query, Peptide peptide){
        /*
         * Inicjalizacja map aminokwasow i modyfikacji
         */
        try
